...
const filterMenuBtn = document.getElementById('text-field__icon-filter');
const filterMenu = document.getElementById('close');

filterMenuBtn.addEventListener('click', function() {
   if(filterMenu.className === 'filter-block') {
      filterMenu.className = 'close';
   } else if (filterMenu.className = 'close') {
...
const priceContent = document.getElementById('price-buy');

dropDownPriceBtn.addEventListener('click', function() {
   if(priceContent.className === 'price-buy') {
      priceContent.className = 'price-buy-close';
   } else if (priceContent.className = 'price-content-close') {
      priceContent.className = 'price-buy';
   }
})
